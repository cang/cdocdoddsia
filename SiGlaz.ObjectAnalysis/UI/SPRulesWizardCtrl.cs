	...
	public class SPRulesWizardCtrl : System.Windows.Forms.UserControl
	{
		...
		private void checkedListBox1_ItemCheck(object sender, System.Windows.Forms.ItemCheckEventArgs e)
		{
			...
			if(e.NewValue==CheckState.Checked)
			{
                ...
                if (!MDCCParam.IsTheSameCondition(ikey))
                {
                ...
                {
                    con.Operator = COMPARE_OPERATOR.EQUAL;
                    con.RHS = 0;
                }
        ...
        public bool IsLimitedCombinationCompareOperator = false;
		private void link1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
		{
			...
			{
                SPCriterionDlg dlg = 
                    new SPCriterionDlg(con, IsLimitedCombinationCompareOperator);
