...
{
    public class DetectContaminationsCommandPoleTip : RasterCommand
    {
        private ArrayList _detectedObjects = null;

        public DetectContaminationsCommandPoleTip(IProgressCallback callback)
            : base(callback)
        {
        }
        ...
        protected override void OnRun(params object[] args)
        {
            ...
            try
            {
                ...
                double threshold = settings.LowerIntensityThreshold_PoleTip;
