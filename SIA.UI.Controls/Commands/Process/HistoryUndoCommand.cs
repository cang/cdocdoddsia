...
{
	/// <summary>
	/// Summary description for HistoryUndoCommand.
	/// </summary>
	public class HistoryUndoCommand : RasterCommand
	{
		public HistoryUndoCommand(IProgressCallback callback) : base(callback)
		{
		}
		...
		protected override void OnRun(params object[] args)
		{
			...
			this.SetStatusText("Undo action...");
