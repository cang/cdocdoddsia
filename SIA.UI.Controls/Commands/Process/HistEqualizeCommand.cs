...
{
	/// <summary>
	/// Summary description for HistEqualizeCommand.
	/// </summary>
	public class HistEqualizeCommand : RasterCommand
	{
		public HistEqualizeCommand(IProgressCallback callback) : base(callback)
		{
		}
