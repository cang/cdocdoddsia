...
namespace SIA.UI.Controls.Commands
{
	...
	/// </summary>
	public class GbcUnsharpCommand : RasterCommand
	{
		...
		protected override void ValidateArguments(params object[] args)
		{
			...
			if (args[1] is UnsharpParam == false)
				throw new ArgumentException("Argument type does not match. Arguments[1] must be UnsharpParam", "arguments");
		}

		protected override void OnRun(params object[] args)
		{
			CommonImage image = args[0] as CommonImage;
			UnsharpParam param = (UnsharpParam)args[1];
