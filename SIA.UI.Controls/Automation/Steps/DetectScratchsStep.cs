...
{
    public class DetectScratchsStep : ProcessStep3
    {
        private const string displayName = "Classify Scratch";
        private const string description = "Scratch Classification.";

		#region Constructors and Destructors

        public DetectScratchsStep()
            : base(Guid.NewGuid().ToString(), displayName, description, ProcessStepCategories.Analysis,
            typeof(DetectScratchsCommand), null,
		...
		public override void Execute(WorkingSpace workingSpace)
		{
            ...
            using (DetectScratchsCommand command = new DetectScratchsCommand(null))
            {
