...
namespace SIA.UI.Controls.Automation.Commands
{
	...
	/// </summary>
	public class FilterRankCommand : AutoCommand
	{
		...
		protected override void ValidateArguments(params object[] args)
		{
			...
			if (args[1] is FilterRankCommandSettings == false)
				throw new ArgumentException("Argument type does not match. Arguments[1] must be FilterRankCommandSettings", "arguments");			
		}

		protected override void OnRun(params object[] args)
		{
			CommonImage image = args[0] as CommonImage;
			FilterRankCommandSettings cmdSettings = (FilterRankCommandSettings)args[1];

			int typeFilter = cmdSettings.TypeFilter;
			int kernel = cmdSettings.SzKernel;
			int pass = cmdSettings.NumPass;			
