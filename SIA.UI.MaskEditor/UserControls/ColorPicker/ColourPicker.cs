...
namespace SIA.UI.MaskEditor.UserControls.ColorPicker
{
	...
	/// </summary>
	/// <remarks>
	/// This control simulates a combo-box style UI but drops down a <see cref="SIA.UI.MaskEditor.UserControls.ColorPicker.ColorPanel">ColorPanel</see>
	/// to allow the user to select a color.
	/// </remarks>
	internal class ColorPicker : System.Windows.Forms.UserControl
	{
		/// <summary> 
		...
		private SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSortOrder panel_colorSortOrder   = ColorPanel.defaultColorSortOrder;
		private Size                       panel_colorWellSize    = ColorPanel.defaultColorWellSize;
		private SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSet       panel_colorSet         = ColorPanel.defaultColorSet;
		...
		/// contained <see cref="SIA.UI.MaskEditor.UserControls.ColorPicker.ColorPanel">ColorPanel</see> is displayed.
		/// </remarks>
		/// <param name="e"></param>
		...
		/// <see cref="SIA.UI.MaskEditor.UserControls.ColorPicker.ColorPanel">ColorPanel</see> control.<br></br><br></br>
		/// See <see cref="SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSet">ColorSet</see>.
		/// </summary>
		...
		public SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSet ColorSet
		{
			get
			{
		...
		/// <see cref="SIA.UI.MaskEditor.UserControls.ColorPicker.ColorPanel">ColorPanel</see> should be sorted.<br></br><br></br>
		/// See <see cref="SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSortOrder">ColorSortOrder</see>.
		/// </summary>
		...
		public SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSortOrder ColorSortOrder
		{
			get
			{
