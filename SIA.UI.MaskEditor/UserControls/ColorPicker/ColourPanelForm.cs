...
namespace SIA.UI.MaskEditor.UserControls.ColorPicker
{
	...
	{
		private SIA.UI.MaskEditor.UserControls.ColorPicker.ColorPanelWithCapture colorPanel = null;
		...
		{
			this.colorPanel = new SIA.UI.MaskEditor.UserControls.ColorPicker.ColorPanelWithCapture();
			this.SuspendLayout();
			// 
			// colorPanel
			// 
			...
			this.colorPanel.ColorSet = SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSet.Web;
			this.colorPanel.ColorSortOrder = SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSortOrder.Brightness;
			...
			this.colorPanel.ColorChanged += new SIA.UI.MaskEditor.UserControls.ColorPicker.ColorChangedEventHandler(this.colorPanel_ColorChanged);
			this.colorPanel.PanelClosing += new SIA.UI.MaskEditor.UserControls.ColorPicker.ColorPanelClosingEventHandler(this.colorPanel_PanelClosing);
		...
		private void colorPanel_ColorChanged(object sender, SIA.UI.MaskEditor.UserControls.ColorPicker.ColorChangedEventArgs e)
		{
