...
namespace SIA.UI.MaskEditor.UserControls.ColorPicker
{
	...
	/// </summary>
	public delegate void ColorChangedEventHandler( object sender, SIA.UI.MaskEditor.UserControls.ColorPicker.ColorChangedEventArgs e );
	...
	/// <br></br>
	/// <br></br>
	/// The set of colors displayed is controlled by the <see cref="SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSet">ColorSet</see> property.
	/// </remarks>
	internal class ColorPanel : System.Windows.Forms.UserControl
	{
		// defaults
		...
		public SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSet ColorSet
		{
			...
			set
			{
				Utils.CheckValidEnumValue( "ColorSet", value, typeof(SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSet) );
		...
		public SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSortOrder ColorSortOrder
		{
			...
			set
			{
				Utils.CheckValidEnumValue( "ColorSortOrder", value, typeof(SIA.UI.MaskEditor.UserControls.ColorPicker.ColorSortOrder) );
