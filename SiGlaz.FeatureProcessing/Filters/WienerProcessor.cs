...
namespace SiGlaz.FeatureProcessing.Filters
{
    unsafe public class WienerProcessor
    {
        ...
        private const double max_intensity = 255;

        private double[] _imageIntegral = null;
        private double[] _squareImageIntegral = null;
        ...
        private void CalcImageIntegrals()
        {
            // get data's length
        ...
        public void Filter(bool isAuto, double noiseLevel)
        {
            CalcImageIntegrals();
