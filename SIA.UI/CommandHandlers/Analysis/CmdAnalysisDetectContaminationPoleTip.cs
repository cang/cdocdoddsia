...
{
    internal class CmdAnalysisDetectContaminationPoleTip : AppWorkspaceCommand
    {
        public const string cmdCommandKey = "CmdAnalysisDetectContaminationPoleTip";
        ...
        private static string description = "Dark object in Pole Tip";

        static CmdAnalysisDetectContaminationPoleTip()
        {
            // nn classify
        ...
        public CmdAnalysisDetectContaminationPoleTip(IAppWorkspace appWorkspace)
        ...
        public override void DoCommand(params object[] args)
        {
            ...
            try
            {
                ...
                using (CommandExecutor cmdExec = new CommandExecutor(workspace))
                {
                    ...
                    result = cmdExec.DoCommandDetectContaminationsPoleTip(image, regionFile, nnModelFile);
                }
