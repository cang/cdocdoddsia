...
{
    internal class CmdAnalysisDetectContamination : AppWorkspaceCommand
	{
        public const string cmdCommandKey = "CmdAnalysisDetectContamination";
        ...
        private static string description = "Dark object in open area";

		static CmdAnalysisDetectContamination()
		{
            //// nn classify
            //Image image = SIAResources.GetMenuIcon("neural_network_classify");
            //menuInfo = 
            //    new MenuInfo(
            //        "&Classify Contamination", Categories.Analysis, Shortcut.None, 610, image, SeparateStyle.None);
            //toolbarInfo = 
            //    new ToolBarInfo(
            //        "Classify Contamination", "Classify Contamination using Neural Network", 610, image, SeparateStyle.Before);
            //shortcutInfo = 
            //    new ShortcutInfo(
            //        "Classify Contamination", Categories.Analysis, 610, SIAResources.GetShortcutIcon("neural_network_classify"));			

            //string description = "Dark object in open area";
            ...
            menuInfo =
                new MenuInfo(
                    ...
                    Categories.Analysis, Shortcut.None, 610, image, SeparateStyle.None);
            toolbarInfo =
                new ToolBarInfo(
                    string.Format("Classify {0}", description),
            ...
            shortcutInfo =
                new ShortcutInfo(
                    string.Format("Classify {0}", description), 
                    Categories.Analysis, 610, SIAResources.GetShortcutIcon("neural_network_classify"));			
		}

        public CmdAnalysisDetectContamination(IAppWorkspace appWorkspace)
		...
		public override void DoCommand(params object[] args)
        {
            ...
            try
            {
                ...
                using (CommandExecutor cmdExec = new CommandExecutor(workspace))
                {
                    ...
                    result = cmdExec.DoCommandDetectContaminations(image, regionFile, nnModelFile);
                }
