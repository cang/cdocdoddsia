...
namespace SIA.Algorithms.Preprocessing.Matching
{
    ...
    {
        protected CorrelationPattern _corrPattern = null;

        public CorrelationMatcher(CorrelationPattern corrPtn)
        {
            _corrPattern = corrPtn;
        }

        public CorrelationMatcher()
        {

        }

        protected unsafe override void Match(ref double confidence, ref int offsetX, ref int offsetY)
        {
            ...
            out int offsetY)
        {
            ...
            if (weightset == null)
            {
                weightset = new double[widthPattern * heightPattern];
        ...
        public virtual double[,] CorrelationCoefficientWeightSet(ushort[] op1, ushort[] op2, int stride1, int stride2, double[] weightset, int[] interestedX, int[] interestedY)
        {
