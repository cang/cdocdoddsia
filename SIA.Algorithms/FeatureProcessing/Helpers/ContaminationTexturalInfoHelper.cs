...
{
    public class ContaminationTexturalInfoHelper
    {
        #region Member fields
        public const string DefaultMaskFileName = "ABS_Contamination_Region.msk";

        private static int _imageWidth = 0;
        private static int _imageHeight = 0;

        private static string _absSettingsPath = "";

        private static Settings _absAlignmentSettings = null;
        ...
        public static string ABSSettingsPath
        {
            get
            {
                if (_absSettingsPath == "")
                ...
                return _absSettingsPath;
            }
        }

        public static Settings ABSAlignmentSettings
        {
            get
            {
                if (_absAlignmentSettings == null)
                {
                    string absSettingsPath = ABSSettingsPath;

                    string filePath =
                        Path.Combine(absSettingsPath, Settings.DefaultFileName_ABS);

                    _absAlignmentSettings = Settings.Deserialize(filePath);
                }

                return _absAlignmentSettings;
            }
        }
            ...
            get
            {
                if (_texturalExtractorSettings == null)
                {
                    ...
                    _texturalExtractorSettingsFile =
                        Path.Combine(absSettingsPath, TexturalExtractorSettings.DefaultFileName);
        ...
        {
            string absSettingsPath =
                SettingsHelper.GetDefaultABSInspectionSettingsFolderPath();

            _maskFile = Path.Combine(absSettingsPath, DefaultMaskFileName);
        ...
        {
            // get image size
            Settings absAlignmentSettings = ABSAlignmentSettings;
        ...
        private static void UpdateInterestedPoints()
        {
            ...
            TexturalExtractorSettings settings = 
                ContaminationTexturalInfoHelper.TexturalExtractorSettings;
